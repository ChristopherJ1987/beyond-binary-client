        ...
        <nav className="fixed top-0 w-full z-50 border-b border-white/10 bg-cyper-bg/80 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <Link to="/" className="flex items-center gap-3 group">
                    <img src={Logo} alt="Beyond Binary Logo" className="h-10 w-auto object-contain transition-all duration-500 brightness-66 group-hover:brightness-5 group-hover:drop-shadow-[0_0_10px_rgba(0,242,255,0.8)]" />
