        ...
        <Section id="contact" className="border-t border-white/5 relative bg-cyber-bg">
            ...
            <div className="relative z-10 bg-card-bg/60 backdrop-blur-md border border-white/5 p-12 md:p-20 text-center rounded-sm w-full">
                <div className="relative z-10 flex flex-col items-center justify-center">
                    <h2 className="font-header text-4xl md:text-6xl text-white uppercase mb-6 leading-tight tracking-tight">
                        Ready to move <br />
                    ...
                    <p className="font-body text-white/50 max-w-xl mx-auto mb-10 text-base md:text-lg leading-relaxed">
